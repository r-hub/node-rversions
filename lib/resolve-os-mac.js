...
function mac_url(version, arch) {
    if (arch == "x86_64") {
        if (version == "3.2.5") {
            ...
            throw "No macOS installers are available for R versions before 2.10.0.";

        } else if (semver.lt(version, "3.4.0")) {
            return "https://cloud.r-project.org/bin/macosx/old/R-" + version + ".pkg";

        } else if (semver.lt(version, "4.0.0")) {
            return "https://cloud.r-project.org/bin/macosx/R-" + version + ".pkg";
        } else {
        ...
        if (semver.lt(version, "4.1.0")) {
            throw "No arm64 macOS installers are available for R versions before 4.1.0.";
        }
