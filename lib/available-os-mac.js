...
function get_release_url_x86_64(version) {
    if (semver.lt(version, "2.15.1")) {
        return `https://cran.r-project.org/bin/macosx/old/R-${version}.pkg`;
    } else if (version == "2.15.1") {
        return "https://cran.r-project.org/bin/macosx/old/R-2.15.1-signed.pkg";
    } else if (semver.lt(version, "3.1.0")) {
        return `https://cran.r-project.org/bin/macosx/old/R-${version}.pkg`;
    } else if (semver.lt(version, "3.2.0")) {
        return `https://cran.r-project.org/bin/macosx/old/R-${version}-mavericks.pkg`;
    } else if (version == "3.2.4") {
        return "https://cran.r-project.org/bin/macosx/old/R-3.2.4-revised.pkg";
    } else if (semver.lte(version, "3.3.3")) {
        return `https://cran.r-project.org/bin/macosx/old/R-${version}.pkg`;
    } else if (semver.lte(version, "3.6.3")) {
        return `https://cran.r-project.org/bin/macosx/el-capitan/base/R-${version}.pkg`;
    } else {
        return `https://cran.r-project.org/bin/macosx/base/R-${version}.pkg`;
    }
}

function get_release_url_arm64(version) {
    return `https://cran.r-project.org/bin/macosx/big-sur-arm64/base/R-${version}-arm64.pkg`;
}
