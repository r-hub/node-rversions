...
env('MACOS2_X86_64', 'https://cran.r-project.org/bin/macosx/big-sur-x86_64/base/R-%s-x86_64.pkg');
env('MACOS_ARM64', 'https://cran.r-project.org/bin/macosx/big-sur-arm64/base/R-%s-arm64.pkg');
env('MACOS2_ARM64', 'https://cran.r-project.org/bin/macosx/big-sur-arm64/base/R-%s-arm64.pkg');
