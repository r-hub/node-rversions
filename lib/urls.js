...
env('WIN_ARM64', 'https://www.r-project.org/nosvn/winutf8/aarch64/R-4-signed/R-%s-aarch64.exe"')
env('DEVEL',   'https://svn.r-project.org/R/trunk/VERSION');
env('DEVEL_WIN', 'https://cran.rstudio.com/bin/windows/base/rdevel.html');
env('DEVEL_WIN_ARM64', 'https://www.r-project.org/nosvn/winutf8/aarch64/prerelease/?F=0&O=D&P=R-devel*')
...
env('PATCHED_WIN_ARM64', 'https://www.r-project.org/nosvn/winutf8/aarch64/prerelease/?F=0&O=D&P=R-patched*')
