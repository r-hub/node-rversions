...
const historic_releases = require('./historic-releases');

const get_version_from_minor = require('./r-minor')
      .internals
      .get_version_from_minor;

let rver = historic_releases.map(x => { x.nickname = null; return x });
rver = rver.concat(
      [
          {
              "version": "0.60",
...
const next_win =
      {
          ...
          "semver": "4.5.1",
          "type": null,
          "URL": 'https://cran.r-project.org/bin/windows/base/R-4.5.1alpha-win.exe'
      }
...
const next_macos_x86_64 =
      {
          ...
          "semver": "4.5.1",
          "type": 'patched',
          "URL": 'https://github.com/r-hub/R/releases/download/vnext/R-next-x86_64.pkg"
      }
...
const next_macos_arm64 =
      {
        ...
        "nickname": "Great Square Root",
        "type": "patched",
        "URL": "https://github.com/r-hub/R/releases/download/vnext/R-next-arm64.pkg"
      }
